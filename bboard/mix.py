...
полнил вход и в чьем отношении переопределенный метод testapp _ func () вернет
в качестве результата значение тrue (в изначальной реализации метод testapp _ func ()
